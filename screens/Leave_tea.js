...
export default function Leave_tea({ navigation }) {
        ...
        <View style={styles.container}>
            ...
            <View style={styles.container1}>
                ...
                <View style={{ marginTop: 5, marginBottom: 5, flexDirection: 'row', justifyContent: 'space-between', marginHorizontal: 5, }}>
                    ...
                    <Text style={styles.txt}> {user.user_fname}  {user.user_lname}</Text>
                </View>
...
const styles = StyleSheet.create({
    ...
    alertModal1: { backgroundColor: "#fff", borderWidth: 4, borderColor: '#81F1AC', height:250, borderRadius: 10, justifyContent: 'center', alignItems: 'center' },
