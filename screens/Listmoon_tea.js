...
import { ShowEvent, ShowEventAll, AllowStatus } from '../services/eventService';
import { Event } from '../services/eventService';
import Modal from 'react-native-modal';

export default function Listmoon_tea({ navigation }) {
 ...
 async function ShowEventData() {
        ...
        function ViewEventStudentAll() {
            ...
            if (dataEventStudent !== null) {
                dataEventStudent.forEach((result, index) => {
                    viewList.push(
                        <View key={index} style={{ marginTop: 10, marginBottom: 0, borderWidth: 1, height: 180, width: 350, padding: 10, borderRadius: 20 }}>
                        <Text
    ...
    return (
        ...
        <View style={{ marginTop: 5, marginBottom: 5, flexDirection: 'row', justifyContent: 'space-between', marginHorizontal: 5, }}>
            ...
            <Text style={styles.textTitle}>รายชื่อรอบเย็น</Text>
            <Image
